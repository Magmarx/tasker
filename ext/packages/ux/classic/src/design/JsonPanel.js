...
/**
 * Created by Desar_6 on 10/12/2014
 * @type {String}
 */
Ext.define('Ext.ux.design.JsonPanel', {
    ...
    setConfig: function(config, callback) {
        ...
        try {
            ...
            me.setTitle(me.titleText + ' [' + Ext.localization.jsonPanel.instanceMode[me.instanceMode + 'Text'] + ']');
            // Add listeners
            if (callback) callback();
        } catch (Error) {
            console.log(Error);
