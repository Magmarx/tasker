...
Ext.define('Ext.ux.widget.grid.Util', {
    initEditors: function() {
        ...
        editors.add('date', new Ext.grid.CellEditor({
            field: new Ext.form.field.Date({
                selectOnFocus: true
            })
        }));
        editors.add('string', new Ext.grid.CellEditor({
        ...
        editors.add('number', new Ext.grid.CellEditor({
            field: new Ext.form.field.Number({
                selectOnFocus: true
            })
        }));
        editors.add('boolean', new Ext.grid.CellEditor({
        ...
        editors.add('0', new Ext.grid.CellEditor({
            floating: true,
            field: new Ext.form.field.Text({
                selectOnFocus: true,
                listeners: {
        ...
        editors.add('1', new Ext.grid.CellEditor({
            floating: true,
            field: new Ext.form.field.Number({
                selectOnFocus: true
            })
        }));
        editors.add('2', new Ext.grid.CellEditor({
            floating: true,
            field: new Ext.form.field.Text({
                selectOnFocus: true,
                listeners: {
        ...
        editors.add('3', new Ext.grid.CellEditor({
            floating: true,
            field: new Ext.form.field.Date({
                selectOnFocus: true
            })
