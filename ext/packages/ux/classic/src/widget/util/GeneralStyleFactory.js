...
Ext.define('Ext.ux.widget.util.GeneralStyleFactory', {
    ...
    //     'Ext.ux.form.field.FieldColorPicker' /**/
    // ],
    // initFactory: function(me) {
    //     var Ex= Ext,
    //         ExLocale =  Ex.localization.simpleStyleConfig;
    //     var widthField = Ex.widget('numberfield',{
    ...
    //
    //         }),
    //         widthUnitField = Ex.widget('combobox',{
    //             editable: false,
    //             //id: "borderStyleText",
    //             name: "widthUnitField",
    //             fieldLabel:  'Unit',
    ...
    //             ]
    //         }),
    //         heightField= Ex.widget('numberfield',{
    ...
    //
    //         }),
    //         heightUnitField = Ex.widget('combobox',{
    //             editable: false,
    //             //id: "borderStyleText",
    ...
    //         }),
    //
    //         borderSizeField= Ex.widget('numberfield',{
    ...
    //
    //         }),
    //         borderStyleField = Ex.widget('combobox',{
    //             editable: false,
    //             // id: "borderStyleText",
    ...
    //             value: 'solid',
    //             store: [
    //                 [ 'solid', ExLocale.fieldLabel.borderStyleValue.solidText ],
    //                 [ 'dashed', ExLocale.fieldLabel.borderStyleValue.dashedText ],
    //                 [ 'dotted', ExLocale.fieldLabel.borderStyleValue.dottedText ],
    //                 [ 'double', ExLocale.fieldLabel.borderStyleValue.doubleText ]
    //             ]
    //         }),
    //         borderField = Ex.widget('checkbox',{
    ...
    //         borderSizeField.allowBlank = !value;
    //         colorPickerField.setVisible(value);
    //     });
    //
    //     var borderFieldSet = Ex.widget('container',{
    //         // id: 'boderFieldSet',
    //         layout: 'hbox',
    ...
    //         height: 110
    //     });
    //     me.getSizeFormConfig = function () {
    //         return innerForm;
    //     };
    //     var colorPickerField = Ex.widget('fieldcolorpicker',{
    //         hidden: me.myConfig? !me.myConfig.border: true,
    //         padding: "0 0 0 15",
