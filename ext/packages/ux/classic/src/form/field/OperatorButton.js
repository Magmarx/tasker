...
Ext.define('Ext.ux.form.field.OperatorButton', {
    ...
    operatorSet: {
        eq: {
            text: 'Is equal to',
            iconCls: Ext.baseCSSPrefix + 'operator-button-equal ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
            value: 'eq'
        },
        ne: {
            text: 'Is not equal to',
            iconCls: Ext.baseCSSPrefix + 'operator-button-not-equal ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
            value: 'ne'
        },
        gte: {
            text: 'Great than or equal',
            iconCls: Ext.baseCSSPrefix + 'operator-button-great-than-equal ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
            value: 'gte'
        },
        lte: {
            text: 'Less than or equal',
            iconCls: Ext.baseCSSPrefix + 'operator-button-less-than-equal ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
            value: 'lte'
        },
        gt: {
            text: 'Great than',
            iconCls: Ext.baseCSSPrefix + 'operator-button-great-than ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
            value: 'gt'
        },
        lt: {
            text: 'Less than',
            iconCls: Ext.baseCSSPrefix + 'operator-button-less-than mouse-over-button',
            value: 'lt'
        }
    },
    ...
    init: function (textField) {
        ...
        me.operatorSet = {
            eq: {
                text: Ext.localization.viewerAlert.operators.eq,
                iconCls: Ext.manifest.globals.fontBasePrefix + 'equal x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'eq'
            },
            ne: {
                text: Ext.localization.viewerAlert.operators.ne,
                iconCls: Ext.manifest.globals.fontBasePrefix + 'not-equal x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'ne'
            },
            gte: {
                text: Ext.localization.viewerAlert.operators.gte,
                iconCls: Ext.manifest.globals.fontBasePrefix + 'great-than-equal  x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'gte'
            },
            lte: {
                text: Ext.localization.viewerAlert.operators.lte,
                iconCls: Ext.manifest.globals.fontBasePrefix + 'less-than-equal x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'lte'
            },
            gt: {
                text: Ext.localization.viewerAlert.operators.gt,
                iconCls: Ext.baseCSSPrefix + 'operator-button-great-than x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'gt'
            },
            lt: {
                text: Ext.localization.viewerAlert.operators.lt,
                iconCls: Ext.baseCSSPrefix + 'operator-button-less-than x-menu-item-icon-default ' + Ext.baseCSSPrefix + 'operator-button-mouse-over-button',
                value: 'lt'
            }
        };
    ...
    onFieldRender: function (textField) {
        ...
        btn = me.operatorButtonEl = me.textField.bodyEl.createChild({
            ...
            style: 'font-size: initial;position: absolute; width: 16px; height: 16px; cursor: pointer; margin-top: 10px; top 2 !important;',
